...
- [ ] Trimming completo.
- [ ] Sin PDB sueltos.
- [ ] Windows: publish nativo en `windows-latest`, EXE self-contained single-file con Zstandard embebido.
- [ ] Windows: bundle single-file sin compresión interna (`EnableCompressionInSingleFile=false`).
