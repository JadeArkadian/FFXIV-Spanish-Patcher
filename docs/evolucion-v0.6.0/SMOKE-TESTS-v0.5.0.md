...
| ST-08 | Mod importado con selección parcial. | Reimportar paquete equivalente con otra selección inicial. | Penumbra conserva o informa claramente sus settings existentes según su flujo normal; el paquete sigue ofreciendo las diez opciones. |
