...
public static class CategoryCatalog
{
    ...
    [
        ...
        new("clases", "Clases y trabajos",
            "Nombres de clases y trabajos y sus categorías (ClassJob, ClassJobCategory). Desmárcala para dejar los nombres de clase/job en inglés."),
